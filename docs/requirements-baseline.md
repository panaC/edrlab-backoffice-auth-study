...
| ID | Priority | Requirement | Source |
| --- | --- | --- | --- |
| `AUTH-001` | Must | Backoffice users authenticate through OAuth2/OIDC-compatible login. | [README](../README.md), [Study notes](./requirements-study-inputs.md) |
...
| `TOKEN-001` | Must | The first study and minimal PoC baseline uses JWT access tokens. | [Study notes](./requirements-study-inputs.md), [Administrator authentication policy](./security-administrator-authentication-policy.md) |
...
| `RBAC-004` | Should | Sensitive operations use explicit permissions, such as `members:read`, `members:disable`, `roles:assign`, and `authorization:check`, rather than one broad admin flag. | [Initial permission model](./requirements-initial-permission-model.md), [Study notes](./requirements-study-inputs.md) |
...
| `RBAC-006` | Future | Role hierarchies, ABAC, relationship-based authorization, separate policy engines, and resource-level permissions are later study topics unless concrete workflows require them. | [Study notes](./requirements-study-inputs.md), [Authorization models](./wiki/18-authorization-models.md) |
...
| `API-005` | Should | Admin mutations have documented validation, idempotency, concurrency behavior, and safe error behavior. | [Study notes](./requirements-study-inputs.md), [Initial permission model](./requirements-initial-permission-model.md) |
| `API-006` | Should | The first baseline treats the Backoffice UI through the BFF as the only admin API consumer; machine callers are later service-client scope. | [Study notes](./requirements-study-inputs.md), [Administrator authentication policy](./security-administrator-authentication-policy.md) |
...
| `AUD-004` | Should | Access review is possible from the member, role, permission, assignment, client, and audit surfaces. | [Study notes](./requirements-study-inputs.md), [Operational model](./operational-model.md) |
