...
| [Keycloak integration scope](./architecture/keycloak-integration-scope.md) | Phase 3 architecture note that separates EDRLab development responsibilities, Keycloak configuration responsibilities, and the SSO session flow for the accepted Keycloak candidate. |
