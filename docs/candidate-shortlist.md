...
| --- | --- | --- |
| 1 | Keycloak, ZITADEL self-hosted, authentik | Establish open-source self-hosted baseline and operational burden. |
| 2 | Auth0, Okta, Microsoft Entra ID, Amazon Cognito, ZITADEL Cloud | Establish managed baseline and lock-in/API fit concerns. |
